# tax-doc-sdk-tax1099cap

Software development kit to generate IRS Form 1099-CAP as PDF file using Financial Data Exchange (FDX) standards including QR codes and embedded JSON.

<img alt="Sample Form" src="samples/Tax1099Cap.sample.png" width="850"/>
