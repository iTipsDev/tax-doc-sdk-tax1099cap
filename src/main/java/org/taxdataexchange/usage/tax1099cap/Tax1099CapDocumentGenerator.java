package org.taxdataexchange.usage.tax1099cap;

import irs.fdxtax641.jsonserializers.Tax1099CapSerializer;
import irs.fdxtax641.map2objects.Map2Tax1099Cap;
import org.taxdataexchange.core.pdfbuilders.Tax1099CapPdfBuilder;
...
public class Tax1099CapDocumentGenerator {
    ...
    private void processOneRow(
        ...
        Tax1099Cap obj = Map2Tax1099Cap.generate( row );
        {
            String asJson = Tax1099CapSerializer.serialize( obj );
    ...
    private void processCsvForCompany(
        ...
        // CSV file
        String csvFileName  = "Tax1099Cap.csv";
        ...
        String outputFileName = "Tax1099Cap.rows.json";
    ...
    public static void main(String[] args) {
        ...
        System.out.println( "Tax1099CapDocumentGenerator Begin" );

        String companyName = "company1";

        Tax1099CapDocumentGenerator generator = new Tax1099CapDocumentGenerator( );

        generator.processCsvForCompany( companyName );

        System.out.println( "Tax1099CapDocumentGenerator Done" );
