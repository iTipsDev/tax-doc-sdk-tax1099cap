...
import org.taxdataexchange.docs.tax1099cap.models.*;
import org.taxdataexchange.docs.tax1099cap.utils.*;
...
public class Tax1099CapDocumentGenerator {
    ...
    public static TaxDataList sampleData( ) {
        ...
        // Sample data
        // -----------------------------------------------------------------
        TaxData taxData = SampleData.sampleTaxData( "Tax1099Cap" );
    ...
    public static void addCoverPage() {
        ...
        String filePath2 = "samples/Tax1099Cap.cover.pdf";
        FileUtils.bytesToFile( combinedBytes, filePath2 );
    ...
    public static void insertQrCode() {
        ...
        String filePath2 = "samples/Tax1099Cap.inserted.pdf";
        FileUtils.bytesToFile( combinedBytes, filePath2 );
